    ...
    return (
        <>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <span className="price-amount">
                            ...
                            {listing.pricing.amount * listing.pricing.nights}
                        </span>
                        <p className="text-caption mt-1">
                            Pour {listing.pricing.nights} nuits · {listing.pricing.dateRange}
                        </p>
            ...
            >
                ...
                <div
                    className="relative bg-primary rounded-t-4xl pt-6 px-4 pb-32 min-h-screen"
                ...
                >
                    ...
                    <p className="text-body-sm text-secondary mb-1 text-center">
                        {listing.subtitle}
                    </p>
                        ...
                        <div className="mt-4 p-4 bg-secondary rounded-xl">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex-1 h-2 bg-tertiary rounded-full overflow-hidden">
                                    <div
                                        ...
                                        style={{
                                            ...
                                            backgroundColor:
                                                listing.antiCat.riskScore < 30
                                                    ? 'var(--color-success)'
                                                    : listing.antiCat.riskScore < 60
                                                      ? 'var(--color-warning)'
                                                      : 'var(--color-error)',
                                        }}
                                    />
                                ...
                                <span className="text-caption">
                                    {listing.antiCat.riskScore}% risque félin
                                </span>
                            </div>
                        </div>
                    )}
                        ...
                        <>
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-body-sm text-secondary">
                                        {listing.host.yearsHosting} ans d'expérience
                                    </p>
                                </div>
                            </div>
                            <div className="divider" />
                    ...
                    {/* Description */}
                    <p
                        className={`text-body leading-relaxed ${!showFullDescription ? 'line-clamp-4' : ''}`}
                    >
                        {listing.description}
                    </p>
                    <button
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-caption">
                                        ...
                                        {listing.locationDetails.country}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="list">
                        <div className="list-item">
                            ...
                            <div className="list-item-content">
                                Aboiements autorisés jusqu'à {listing.rules.maxBarkHour}
                            </div>
                        </div>
                        <div className="list-item">
                            <div className="list-item-icon">
                            ...
                            <div className="list-item-content">
                                {listing.rules.mustBeVaccinated
                                    ? 'Vaccination obligatoire'
                                    : 'Vaccination non requise'}
                            </div>
                        </div>
                        <div className="list-item">
                            <div className="list-item-icon">
                            ...
                            <div className="list-item-content">
                                {listing.rules.mustBeNeutered
                                    ? 'Stérilisation obligatoire'
                                    : 'Stérilisation non requise'}
                            </div>
                        </div>
                        <div className="list-item">
                            <div className="list-item-icon">
                        ...
                        <div>
                            <p className="text-body">
                                {listing.cancellationPolicy === 'flexible' &&
                                    "Annulation gratuite jusqu'a 24h avant l'arrivée"}
                                {listing.cancellationPolicy === 'moderate' &&
                                    "Annulation gratuite jusqu'a 5 jours avant l'arrivée"}
                                {listing.cancellationPolicy === 'strict' &&
                                    "Remboursement de 50% jusqu'a 7 jours avant l'arrivée"}
                            </p>
                        </div>
                    </div>
