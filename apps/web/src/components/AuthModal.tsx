...
export const AuthModal = () => {
    ...
    return (
        ...
        >
            <div 
                className="relative w-full max-h-[90vh] bg-white rounded-t-[24px] overflow-hidden"
                    ...
                    {step === 'email' ? (
                        ...
                        <form onSubmit={handlePasswordSubmit} className="flex flex-col gap-4">
                            ...
                            >
                                ...
                                <span className="text-body-sm" style={{ color: '#0066ff' }}>Modifier</span>
                            </button>
                            ...
                            <button
                                ...
                                style={{ opacity: (isLoading || !password || (isNewUser && !pseudo)) ? 0.5 : 1 }}
                            >
                                {isLoading ? 'Chargement...' : (isNewUser ? 'Créer un compte' : 'Se connecter')}
                            </button>
                        </form>
                    )}
                </div>
