...
export const AuthModal = () => {
    const { isAuthModalOpen, closeAuthModal, login, register, loginWithGoogle, loginWithApple, loginWithFacebook } = useAuth();
                    ...
                    {step === 'choice' && (
                        <div className="flex flex-col gap-6">
                            <div className="text-center mb-2">
                                <h2 className="text-xl font-semibold mb-1">Bienvenue sur AirBnBark 🐕</h2>
                                <p className="text-secondary text-sm">Connecte-toi ou crée un compte pour continuer</p>
                            </div>
                    ...
                    {step === 'register' && (
                        <form onSubmit={handleRegisterSubmit} className="flex flex-col gap-4">
                            <div className="text-center mb-2">
                                ...
                                <p className="text-secondary text-sm">Crée ton compte en quelques secondes</p>
                            </div>
                            ...
                            <button
                                type="submit"
                                className="btn-primary btn-full mt-2"
                                disabled={isLoading || !pseudo || !email || !password || !confirmPassword}
                                style={{ opacity: isLoading || !pseudo || !email || !password || !confirmPassword ? 0.5 : 1 }}
                            >
